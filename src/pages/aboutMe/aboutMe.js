    ...
    return (
        <div className="container">
            <div className="title">About Me</div>
                <p className="bio">
                    <span>Hi! My name is Sophie and I'm a full-stack developer based in Denver, CO.</span> <br />
                    ...
                    <span>When I'm not coding, I like to spend my time skiing, hiking, traveling, cooking, playing piano, being active, learning new things, and being with my boyfriend and our dog, Peanut!</span>
                </p>
        </div>
    );
}
