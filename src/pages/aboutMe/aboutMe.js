        ...
        <div className="container">
            <div className="title">About Me</div>
                <div className="bio">
                    ...
                    <p>When I'm not coding, I enjoy skiing, hiking, traveling, being active, spending time outside, spending time with my boyfriend and dog, Peanut, cooking, baking, yoga, pilates, running, playing piano, painting, reading, learning.</p>
                </div>
        </div>
    );
}
