        ...
        <div className="container">
            <div className="title">About Me</div>
                <p className="bio">
                    ...
                    I currently work as a teaching assistant for the University of Utah Coding Boot Camp. I was a student in the University of Denver Coding Boot Camp from July-October 2022. I learned HTML5, CSS3, Javascript, jQuery, Express.js, React.js, Node.js, MySQL, and MongoDB, as well as how to collaborate with others to complete coding projects. Prior to the Boot Camp I was working as a rehab tech at an inpatient rehabilitation hospital. In my coding work I enjoy using my problem-solving skills, creativity, adaptability, and curiosity. <br className="break"/>
